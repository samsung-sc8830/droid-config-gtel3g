# DisplayName: Jolla gtel3g/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: gtel3g
# DeviceVariant: gtel3g
# Brand: Jolla
...
repo --name=adaptation-common-gtel3g-@RELEASE@ --baseurl=https://releases.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-common/@ARCH@/
repo --name=adaptation-community-common-gtel3g-@RELEASE@ --baseurl=https://repo.sailfishos.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
patterns-sailfish-device-configuration-gtel3g
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/gtel3g
